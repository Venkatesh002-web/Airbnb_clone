                 ...
                 <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols:4 lg:grid-cols-6">
                     {addedPhotos.length>0 && addedPhotos.map(link =>(
                         <div className="h-32 flex relative" key={link}>
                             <img className="rounded-2xl object-cover w-full " src={'http://localhost:4000/uploads/'+link}/>
                     ...
                     <label className="h-32 cursor-pointer flex items-center gap-2 justify-center border bg-transparent rounded-2xl p-2 text-gray-600">
